    ...
    public function run(): void
    {
        ...
        for ($i = 1; $i <= 100; $i++) {
            ...
            $books[] = [
                ...
                'categories' => json_encode(collect($selectedCategories)->map(fn($index) => $categories[$index])->toArray()),
                'authors' => json_encode(collect($selectedAuthors)->map(fn($index) => $authors[$index])->toArray()),
